...
RLAPI void *GetWindow(void);                                      // CUSTOM THING: Get native window handle
...
RLAPI void DrawModelExPlus(Model model, Vector3 position, Vector3 rotationAxis, Vector3 rotationAngles, Vector3 scale, Color tint); // Draw a model with extended parameters
